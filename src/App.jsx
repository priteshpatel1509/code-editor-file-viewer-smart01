    ...
    >
      ...
      <style>{`
        @media (max-width: 768px) {
          ...
          .zip-table th, .zip-table td { padding: 8px !important; font-size: 0.75rem !important; }
        }
        @keyframes fadeIn { from { opacity: 0; } to { opacity: 1; } }
        /* ADDED: Word styling for rendering */
        .docx-wrapper { padding: 20px !important; background: transparent !important; }
        .docx { background: white !important; color: black !important; padding: 40px !important; box-shadow: 0 10px 30px rgba(0,0,0,0.4); border-radius: 4px; margin: 0 auto; max-width: 850px; }
        
        /* ADDED: Excel Styling */
        .excel-table { border-collapse: collapse; width: max-content; min-width: 100%; background: white; color: #1e293b; }
        .excel-table th, .excel-table td { border: 1px solid #cbd5e1; padding: 10px 15px; font-size: 0.85rem; text-align: left; }
        .excel-table th { background: #f1f5f9; font-weight: bold; position: sticky; top: 0; z-index: 10; }
      ...
      <div className="main-content" style={{ display: "flex", flex: 1, overflow: "hidden" }}>
        ...
        <main style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center", padding: "20px 0", flex: 1, overflowY: "auto", marginBottom: library.length > 0 ? (isMobile ? "180px" : "110px") : "0" }}>
          {type ? (
            <div style={{ width: "96%", display: "flex", flexDirection: "column", gap: "25px" }} className="audio-inner-container">
              <div className="studio-main-card" style={{ background: "#0f172a", borderRadius: "16px", border: "1px solid #334155", minHeight: "70vh", width: "100%", display: "flex", flexDirection: "column", overflow: "hidden", position: 'relative' }}>
                ...
                <div style={{ flex: 1, display: "flex", justifyContent: "center", alignItems: "center", background: "#000", position: 'relative', overflow: 'hidden', padding: isMobile ? "10px" : "20px" }}>
                  ...
                  {type === "word" && (
                    <div style={{ width: "100%", height: "100%", overflow: "auto", padding: "20px", background: "#334155" }}>
                  ...
                  {type === "archive" && (
                    <div style={{ width: '100%', height: '100%', padding: '20px', overflow: 'auto', background: "#0f172a" }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', borderBottom: '1px solid #334155', paddingBottom: '15px' }}>
                        <h3 style={{ color: '#38bdf8', margin: 0 }}>📦 Archive Browser: {fileName}</h3>
                        {!extractedFolder && (
                          <button 
                            onClick={unzipAllAndBrowse}
                            style={{ background: '#f59e0b', color: '#000', border: 'none', padding: '10px 20px', borderRadius: '8px', fontWeight: 'bold', cursor: 'pointer', boxShadow: '0 0 15px rgba(245, 158, 11, 0.3)' }}
                          >
                            ⚡ Extract All & Browse
                          </button>
                        )}
                      ...
                      <table className="zip-table" style={{ width: '100%', borderCollapse: 'collapse', color: '#f8fafc', fontSize: '0.9rem' }}>
                        ...
                        <tbody>
                          {zipFiles.map((f, i) => (
                            <tr key={i} style={{ borderBottom: '1px solid #1e293b', background: i % 2 === 0 ? 'transparent' : '#1e293b' }}>
                              <td style={{ padding: '12px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                                {f.dir ? "📁" : "📄"} <span style={{ color: f.dir ? "#fbbf24" : "#38bdf8" }}>{f.name}</span>
                              </td>
                              <td style={{ padding: '12px', color: '#64748b' }}>{f.dir ? "Folder" : "File"}</td>
                              <td style={{ padding: '12px' }}>{f.dir ? "--" : f.size}</td>
                                  ...
                                  <div style={{ display: 'flex', gap: '10px' }}>
                                    {extractedFolder && extractedFolder[f.name] ? (
                                      <button 
                                        ...
                                        style={{ background: "#10b981", color: "white", border: "none", padding: "6px 12px", borderRadius: "4px", fontSize: "0.75rem", cursor: "pointer", fontWeight: "600" }}
                                      >
                                        Open in Editor
                                      </button>
                                    ) : (
                                      <button 
                                        ...
                                        style={{ background: "#2563eb", color: "white", border: "none", padding: "6px 12px", borderRadius: "4px", fontSize: "0.75rem", cursor: "pointer" }}
                                      >
                                        Download
                                      </button>
                                    )}
              ...
              <div style={{ height: isMobile ? "100px" : "20px" }}></div>
            </div>
          ) : (
